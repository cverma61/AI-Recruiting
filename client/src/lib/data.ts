export const purplefishReview = {
  ...
  verdict: {
    score: 8.5,
    summary: "Purplefish is a strong contender for staffing teams needing speed and ATS consistency. It sacrifices deep assessment depth for workflow efficiency and ease of use.",
    pros: [
      "Direct ATS writeback of transcripts and outcomes",
      "High throughput for screening calls",
      "Seamless candidate handoff",
      "Simple configuration for role-specific questions"
    ],
    cons: [
      "Limited assessment depth for complex roles",
      "Not a replacement for full structured interviews",
      "Reporting can be basic compared to enterprise suites"
    ]
  },
  sections: [
    {
      id: "what-is-it",
      title: "What Purplefish is and is not",
      content: `### What Purplefish is
...
- Not a deep skills assessment platform for hard skill validation`
    ...
    {
      id: "who-fits-best",
      title: "Who Purplefish fits best",
      content: `Purplefish tends to be most attractive when cost, speed, and workflow fit are the primary decision drivers.
...
- Organizations that need high engagement and strong candidate experience`
    ...
    {
      id: "how-it-works",
      title: "How Purplefish works end to end",
      content: `A typical flow looks like this:
...
5. **Recruiter review and next step**  
   Recruiters review the record and route candidates forward`
    },
    {
      ...
      content: `### AI phone screens that reduce recruiter load
...
Most buyers need screens that map to role requirements, client preferences, and deal breakers. You can author and update question sets and support different screens by role family or client.

### Reporting for throughput and conversion
To manage a screening program, you need visibility into:
...
- Pass through rate and downstream quality signals`
    ...
    {
      id: "ats-integration",
      title: "ATS integrations and data flow",
      content: `### Transcript and outcome writeback
Strong writeback reduces tool switching, improves adoption, and creates a clean audit trail.
...
Staffing agencies often run many workflows across clients. Purplefish supports configuration patterns that match these complex operating models.`
    },
    {
      id: "candidate-experience",
      title: "Candidate experience",
      content: `Voice screening only works if candidates complete it. Purplefish tends to work best when:
...
- The agent can handle natural speech without forcing strict phrasing`
    ...
    {
      id: "governance",
      title: "Governance, audits, and bias controls",
      content: `### What most SMB and mid market teams need
...
- Auditable artifacts that explain how an outcome was reached`
    },
    {
      ...
      content: `A practical rollout plan:
...
- Pilot, measure, then expand role coverage`
    },
    {
      ...
      content: `Pricing is usually tied to volume and scope.
...
- Speed to submit for staffing`
    },
    {
      ...
      content: `- **Explainability may require extra work**: Transcripts alone do not guarantee explainability.
- **Audit readiness is not a default state**: Confirm artifacts match your internal standards.
- **Fraud controls may sit outside the product**: Identity checks may require a separate step.
...
4. Review what is written back into your ATS
...
- Does support coverage match your hiring hours`
  ...
  alternatives: [
    {
      name: "Tenzo AI",
      description: "Best for enterprise teams needing structured scoring, compliance audits, and fraud controls.",
      bestFor: "Enterprise & Compliance"
    },
    {
      name: "Paradox",
      description: "Best for high-volume scheduling and engagement rather than just screening.",
      bestFor: "Scheduling & Engagement"
    },
    {
      name: "HireVue",
      description: "Best for structured video interviews and deeper assessments.",
      bestFor: "Structured Interviews"
    },
    {
      name: "Modern Hire",
      description: "Best for assessment-centered programs with enterprise reporting needs.",
